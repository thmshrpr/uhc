...
GRINC_AGGRINCODE_ALLTRF_MAIN_SRC_CAG	:= $(patsubst %,$(SRC_GRINC_PREFIX)GrinCode/Trf/%.cag,DropUnusedExpr NameIdents SparseCase NormForHPT NumberIdents CaseElimination SplitFetch DropUnusedTags GrInline RightSkew LowerGrin CopyPropagation BuildAppBindings ReturningCatch CleanupPass Identity CaseHoisting Inliner SubstituteVars)
